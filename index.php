...
if (isset($_GET['delete_id'])) {
    $programController->deleteProgram((int)$_GET['delete_id']);
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="index.php?delete_id=<?= urlencode($program['id']) ?>" onclick="return confirm('Are you sure you want to delete this program?');">🗑 Delete</a> |
